      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose dark:prose-invert max-w-none text-muted-foreground">
          ...
          <div className="p-6 bg-slate-50 dark:bg-slate-900 rounded-2xl mb-12">
            <p className="mb-0">
              欢迎使用秒构AI（Ingenio）。我们深知个人信息对您的重要性，并承诺采取严格的安全保护措施，依法保护您的隐私信息。本《隐私政策》将详细说明我们在您使用服务时如何收集、使用、存储、共享和保护您的个人信息。
            </p>
          </div>
          ...
          <ul className="list-disc pl-6 mb-8 space-y-3">
            <li><strong>账户注册与认证：</strong> 当您注册秒构AI账户时，我们需要收集您的手机号码、电子邮箱或第三方社交账号信息，以便为您创建唯一的用户身份。</li>
          ...
          <ul className="list-disc pl-6 mb-8 space-y-3">
            <li><strong>代码所有权：</strong> 您使用秒构AI生成的应用程序代码、设计稿及相关资产的知识产权完全归您所有。我们不会对您生成的最终产品主张版权。</li>
