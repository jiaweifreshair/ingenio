      ...
      <main className="flex-1 container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose dark:prose-invert max-w-none text-muted-foreground">
          ...
          <div className="p-6 bg-slate-50 dark:bg-slate-900 rounded-2xl mb-12">
            <p className="mb-0">
              欢迎使用Ingenio 妙构（Ingenio）。本协议是您与Ingenio 妙构之间关于使用我们提供的AI应用生成及相关服务所订立的法律协议。请您在注册和使用服务前仔细阅读。一旦您使用我们的服务，即表示您已同意接受本条款的约束。
            </p>
          </div>
          
          <h2 className="text-2xl font-semibold mt-12 mb-6 text-foreground">1. 服务内容与账户</h2>
          <ul className="list-disc pl-6 mb-8 space-y-3">
            <li><strong>服务描述：</strong> Ingenio 妙构提供基于人工智能的代码生成、UI设计、云端部署及相关辅助工具。我们致力于提供高质量的生成结果，但鉴于AI技术的概率性特征，我们不保证生成结果完全准确无误或满足所有特殊需求。</li>
          ...
          <ul className="list-disc pl-6 mb-8 space-y-3">
            <li><strong>平台权益：</strong> Ingenio 妙构平台的算法、模型、源代码、界面设计及商标等知识产权均归我们所有。</li>
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 p-6 rounded-xl mb-8">
            ...
            <p className="mb-0 text-sm text-amber-900/80 dark:text-amber-100/80">
              本服务按&quot;原样&quot;和&quot;现有&quot;基础提供。Ingenio 妙构不对AI生成代码的安全性、可靠性、适用性作任何明示或暗示的保证。在将生成代码用于生产环境前，您有责任进行充分的测试和安全审查。对于因使用本服务导致的任何直接、间接、偶然或后果性损失（包括但不限于数据丢失、利润损失），我们在法律允许的范围内免责。
            </p>
          </div>
