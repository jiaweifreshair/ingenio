...
export const AI_CAPABILITIES: AICapability[] = [
  // ===== 对话交互类 (3种) =====
  {
    ...
    techStack: ['Gemini 3.0 Pro', 'Ktor HTTP', 'WebSocket', 'Redis'],
    estimatedDays: 2,
    isPopular: true,
  },
  {
    ...
    techStack: ['Gemini 3.0 Pro', 'Embedding', 'Vector DB', 'Ktor'],
    estimatedDays: 2,
  },
  {
    ...
    techStack: ['Gemini 3.0 Pro', 'Embedding API', 'Supabase pgvector', 'Ktor'],
    estimatedDays: 4,
    isNew: true,
  },
  ...
  // ===== 数据分析类 (3种) =====
  {
    ...
    techStack: ['Gemini 3.0 Pro', 'NLP', 'Ktor', 'PostgreSQL'],
    estimatedDays: 2,
  },
  {
  ...
  // ===== 内容生成类 (3种) =====
  {
    ...
    techStack: ['Gemini 3.0 Pro', 'Template Engine', 'Ktor', 'Redis'],
    estimatedDays: 2,
    isPopular: true,
  },
  {
  ...
  // ===== 内容审核类 (1种) =====
  {
    ...
    techStack: ['Aliyun Content Security', 'Gemini 3.0 Pro', 'Ktor', 'Redis'],
    estimatedDays: 3,
  },
