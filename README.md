...
[特性](#-功能特性) • [架构](#-技术架构) • [快速开始](#-快速开始) • [文档](#-文档索引)
...
Ingenio (妙构) 是一个颠覆性的 AI 编程平台。不同于市面上仅生成 "Demo 级" 代码的工具，Ingenio 引入了 **"虚拟研发团队"** 概念，通过 **G3 引擎** 的红蓝博弈机制，实现代码的自我验证与修复，最终交付可直接用于生产环境的 **Spring Boot + Next.js** 全��应用。
...
- **GitHub**: https://github.com/yourusername/Ingenio
