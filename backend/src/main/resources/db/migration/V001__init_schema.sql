...
CREATE TABLE IF NOT EXISTS g3_planning_files (
    ...
    created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT fk_g3_planning_files_job FOREIGN KEY (job_id) REFERENCES g3_jobs(id) ON DELETE CASCADE,
...
CREATE INDEX idx_g3_planning_files_type ON g3_planning_files(file_type);
