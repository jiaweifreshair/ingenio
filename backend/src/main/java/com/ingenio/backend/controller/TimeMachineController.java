...
public class TimeMachineController {
     ...
     * 获取代码级别差异
     *
     * <p>详细的文件级别差异对比，包含新增/删除/修改的文件及行数统计</p>
     *
     * @param version1 版本1 ID
     * @param version2 版本2 ID
     * @return 代码级别差异
     ...
     * 搜索版本
     *
     * <p>按条件筛选版本：类型、状态、标签、时间范围、版本号范围</p>
     *
     * @param taskId        任务ID
     ...
     * 获取版本统计
     *
     * <p>统计信息包含：总版本数、按类型/状态分布、回滚次数、标签版本数等</p>
     *
     * @param taskId 任务ID
     * @return 版本统计信息
     */
