...
public class AIRepairPromptBuilder {
  ...
  public AIRepairPromptBuilder(String failureType, Map<String, Object> errorDetails, String codeSnippet,
      String language, List<Map<String, Object>> previousRepairs) {
    this.failureType = failureType;
    this.errorDetails = errorDetails;
    this.codeSnippet = codeSnippet;
    this.language = language;
    this.previousRepairs = previousRepairs;
  }

  public static AIRepairPromptBuilderBuilder builder() {
    return new AIRepairPromptBuilderBuilder();
  }

  public static class AIRepairPromptBuilderBuilder {
    private String failureType;
    private Map<String, Object> errorDetails;
    private String codeSnippet;
    private String language;
    private List<Map<String, Object>> previousRepairs;

    public AIRepairPromptBuilderBuilder failureType(String failureType) {
      this.failureType = failureType;
      return this;
    }

    public AIRepairPromptBuilderBuilder errorDetails(Map<String, Object> errorDetails) {
      this.errorDetails = errorDetails;
      return this;
    }

    public AIRepairPromptBuilderBuilder codeSnippet(String codeSnippet) {
      this.codeSnippet = codeSnippet;
      return this;
    }

    public AIRepairPromptBuilderBuilder language(String language) {
      this.language = language;
      return this;
    }

    public AIRepairPromptBuilderBuilder previousRepairs(List<Map<String, Object>> previousRepairs) {
      this.previousRepairs = previousRepairs;
      return this;
    }

    public AIRepairPromptBuilder build() {
      return new AIRepairPromptBuilder(failureType, errorDetails, codeSnippet, language, previousRepairs);
    }
  }
  ...
  public List<Map<String, Object>> getPreviousRepairs() {
